-- Bodyshop AI Seed Data - Documents and Chunks
-- Generated SQL for seeding documents and their chunks

-- Document 1: Vehicle Disassembly Safety Checklist
DO $$
DECLARE doc_id_1 UUID;
BEGIN
  INSERT INTO public.documents (
    title, description, doc_type, tab_slug, tags, language, is_active, metadata
  ) VALUES (
    'Vehicle Disassembly Safety Checklist',
    'VEHICLE DISASSEMBLY SAFETY CHECKLIST
...
PERSONAL PROT',
    'checklist',
    'vehicle-disassembly',
    ARRAY['safety', 'ppe', 'checklist', 'procedures'],
    'en',
    true,
    '{"source": "seed-script"}'::jsonb
  ) RETURNING id INTO doc_id_1;
...
☐ Establish communication system if multiple people working on vehicle',
    414,
    '{"title": "Vehicle Disassembly Safety Checklist", "tab": "vehicle-disassembly"}'::jsonb
  );
END $$;

-- Document 2: Front End Disassembly Procedure
DO $$
DECLARE doc_id_2 UUID;
BEGIN
  INSERT INTO public.documents (
    title, description, doc_type, tab_slug, tags, language, is_active, metadata
  ) VALUES (
    'Front End Disassembly Procedure',
    'FRONT END DISASSEMBLY PROCEDURE
...
ST',
    'procedure',
    'vehicle-disassembly',
    ARRAY['front-end', 'bumper', 'disassembly', 'procedures'],
    'en',
    true,
    '{"source": "seed-script"}'::jsonb
  ) RETURNING id INTO doc_id_2;
...
5. Document all damage with photos and measurements',
    581,
    '{"title": "Front End Disassembly Procedure", "tab": "vehicle-disassembly"}'::jsonb
  );
END $$;

-- Document 3: Door and Side Panel Removal Guide
DO $$
DECLARE doc_id_3 UUID;
BEGIN
  INSERT INTO public.documents (
    title, description, doc_type, tab_slug, tags, language, is_active, metadata
  ) VALUES (
    'Door and Side Panel Removal Guide',
    'DOOR AND SIDE PANEL REMOVAL GUIDE
...
1. Loc',
    'procedure',
    'vehicle-disassembly',
    ARRAY['doors', 'panels', 'disassembly', 'trim'],
    'en',
    true,
    '{"source": "seed-script"}'::jsonb
  ) RETURNING id INTO doc_id_3;
...
7. Place mirror on padded surface to prevent breakage',
    543,
    '{"title": "Door and Side Panel Removal Guide", "tab": "vehicle-disassembly"}'::jsonb
  );
END $$;

-- Document 4: Parts Labeling and Storage Best Practices
DO $$
DECLARE doc_id_4 UUID;
BEGIN
  INSERT INTO public.documents (
    title, description, doc_type, tab_slug, tags, language, is_active, metadata
  ) VALUES (
    'Parts Labeling and Storage Best Practices',
    'PARTS LABELING AND STORAGE BEST PRACTICES
...
',
    'procedure',
    'vehicle-disassembly',
    ARRAY['organization', 'storage', 'documentation', 'procedures'],
    'en',
    true,
    '{"source": "seed-script"}'::jsonb
  ) RETURNING id INTO doc_id_4;
...
9. Rotate storage so oldest jobs move through workflow first (FIFO principle)',
    603,
    '{"title": "Parts Labeling and Storage Best Practices", "tab": "vehicle-disassembly"}'::jsonb
  );
END $$;

-- Document 5: Electrical Disconnect and Harness Handling
DO $$
DECLARE doc_id_5 UUID;
BEGIN
  INSERT INTO public.documents (
    title, description, doc_type, tab_slug, tags, language, is_active, metadata
  ) VALUES (
    'Electrical Disconnect and Harness Handling',
    'ELECTRICAL DISCONNECT AND HARNESS HANDLING
...
CONNECTOR T',
    'procedure',
    'vehicle-disassembly',
    ARRAY['electrical', 'connectors', 'wiring', 'procedures'],
    'en',
    true,
    '{"source": "seed-script"}'::jsonb
  ) RETURNING id INTO doc_id_5;
...
6. Verify harness clips are intact and replace any damaged clips before routing',
    559,
    '{"title": "Electrical Disconnect and Harness Handling", "tab": "vehicle-disassembly"}'::jsonb
  );
  INSERT INTO public.document_chunks (
    document_id, chunk_index, content, token_count, metadata
  ) VALUES (
...
-- Document 6: Dent Repair and Metal Finishing Procedures
DO $$
DECLARE doc_id_6 UUID;
BEGIN
  INSERT INTO public.documents (
    title, description, doc_type, tab_slug, tags, language, is_active, metadata
  ) VALUES (
    'Dent Repair and Metal Finishing Procedures',
    'DENT REPAIR AND METAL FINISHING PROCEDURES
...
HAMMER',
    'procedure',
    'auto-body-repairs',
    ARRAY['dent-repair', 'metal-work', 'procedures', 'finishing'],
    'en',
    true,
    '{"source": "seed-script"}'::jsonb
  ) RETURNING id INTO doc_id_6;
...
8. Final contour should match adjacent panels with no steps, gaps, or misalignment',
    603,
    '{"title": "Dent Repair and Metal Finishing Procedures", "tab": "auto-body-repairs"}'::jsonb
  );
END $$;

-- Document 7: Body Filler Application Guide
DO $$
DECLARE doc_id_7 UUID;
BEGIN
  INSERT INTO public.documents (
    title, description, doc_type, tab_slug, tags, language, is_active, metadata
  ) VALUES (
    'Body Filler Application Guide',
    'BODY FILLER APPLICATION GUIDE
...
1. Inspect panel ',
    'procedure',
    'auto-body-repairs',
    ARRAY['body-filler', 'application', 'mixing', 'procedures'],
    'en',
    true,
    '{"source": "seed-script"}'::jsonb
  ) RETURNING id INTO doc_id_7;
...
8. For final shaping, use 220 grit and sand until surface is smooth and contour matches adjacent panels',
    638,
    '{"title": "Body Filler Application Guide", "tab": "auto-body-repairs"}'::jsonb
  );
  INSERT INTO public.document_chunks (
    document_id, chunk_index, content, token_count, metadata
  ) VALUES (
...
-- Document 8: Panel Replacement and Welding Procedures
DO $$
DECLARE doc_id_8 UUID;
BEGIN
  INSERT INTO public.documents (
    title, description, doc_type, tab_slug, tags, language, is_active, metadata
  ) VALUES (
    'Panel Replacement and Welding Procedures',
    'PANEL REPLACEMENT AND WELDING PROCEDURES
...
SPOT WELD DRILLIN',
    'procedure',
    'auto-body-repairs',
    ARRAY['panel-replacement', 'welding', 'procedures', 'mig'],
    'en',
    true,
    '{"source": "seed-script"}'::jsonb
  ) RETURNING id INTO doc_id_8;
...
10. Apply welds in sequence: top, bottom, middle, then sides to distribute heat evenly',
    504,
    '{"title": "Panel Replacement and Welding Procedures", "tab": "auto-body-repairs"}'::jsonb
  );
  INSERT INTO public.document_chunks (
    document_id, chunk_index, content, token_count, metadata
  ) VALUES (
...
-- Document 9: Structural and Frame Straightening Overview
DO $$
DECLARE doc_id_9 UUID;
BEGIN
  INSERT INTO public.documents (
    title, description, doc_type, tab_slug, tags, language, is_active, metadata
  ) VALUES (
    'Structural and Frame Straightening Overview',
    'STRUCTURAL AND FRAME STRAIGHTENING OVERVIEW
...
MEASURING POINTS ',
    'procedure',
    'auto-body-repairs',
    ARRAY['frame-straightening', 'measuring', 'procedures', 'alignment'],
    'en',
    true,
    '{"source": "seed-script"}'::jsonb
  ) RETURNING id INTO doc_id_9;
...
9. If measurements are still out of specification, identify which area needs additional work and repeat straightening sequence',
    638,
    '{"title": "Structural and Frame Straightening Overview", "tab": "auto-body-repairs"}'::jsonb
  );
END $$;

-- Document 10: Corrosion Protection After Repairs
DO $$
DECLARE doc_id_10 UUID;
BEGIN
  INSERT INTO public.documents (
    title, description, doc_type, tab_slug, tags, language, is_active, metadata
  ) VALUES (
    'Corrosion Protection After Repairs',
    'CORROSION PROTECTION AFTER REPAIRS
...
1. Cav',
    'procedure',
    'auto-body-repairs',
    ARRAY['corrosion', 'protection', 'sealers', 'procedures'],
    'en',
    true,
    '{"source": "seed-script"}'::jsonb
  ) RETURNING id INTO doc_id_10;
...
8. Allow products to dry per manufacturer instructions before assembly',
    582,
    '{"title": "Corrosion Protection After Repairs", "tab": "auto-body-repairs"}'::jsonb
  );
  INSERT INTO public.document_chunks (
    document_id, chunk_index, content, token_count, metadata
  ) VALUES (
...
-- Document 11: Paint Booth Preparation Checklist
DO $$
DECLARE doc_id_11 UUID;
BEGIN
  INSERT INTO public.documents (
    title, description, doc_type, tab_slug, tags, language, is_active, metadata
  ) VALUES (
    'Paint Booth Preparation Checklist',
    'PAINT BOOTH PREPARATION CHECKLIST
...
BOOTH CLEANING AND',
    'checklist',
    'painting',
    ARRAY['paint-booth', 'preparation', 'safety', 'checklist'],
    'en',
    true,
    '{"source": "seed-script"}'::jsonb
  ) RETURNING id INTO doc_id_11;
...
☐ Ensure all light fixtures are secure and not at risk of falling',
    614,
    '{"title": "Paint Booth Preparation Checklist", "tab": "painting"}'::jsonb
  );
  INSERT INTO public.document_chunks (
    document_id, chunk_index, content, token_count, metadata
  ) VALUES (
...
-- Document 12: Surface Preparation and Masking Guide
DO $$
DECLARE doc_id_12 UUID;
BEGIN
  INSERT INTO public.documents (
    title, description, doc_type, tab_slug, tags, language, is_active, metadata
  ) VALUES (
    'Surface Preparation and Masking Guide',
    'SURFACE PREPARATION AND MASKING GUIDE
...
1. Inspect',
    'procedure',
    'painting',
    ARRAY['surface-prep', 'masking', 'sanding', 'procedures'],
    'en',
    true,
    '{"source": "seed-script"}'::jsonb
  ) RETURNING id INTO doc_id_12;
...
8. Reverse masking is critical for undetectable repairs on visible panels',
    647,
    '{"title": "Surface Preparation and Masking Guide", "tab": "painting"}'::jsonb
  );
  INSERT INTO public.document_chunks (
    document_id, chunk_index, content, token_count, metadata
  ) VALUES (
...
-- Document 13: Primer Application Procedures
DO $$
DECLARE doc_id_13 UUID;
BEGIN
  INSERT INTO public.documents (
    title, description, doc_type, tab_slug, tags, language, is_active, metadata
  ) VALUES (
...
1. Epoxy primer',
    'procedure',
    'painting',
    ARRAY['primer', 'application', 'spray-technique', 'procedures'],
    'en',
    true,
    '{"source": "seed-script"}'::jsonb
  ) RETURNING id INTO doc_id_13;
...
10. Apply primer in controlled, light passes rather than heavy wet coats',
    590,
    '{"title": "Primer Application Procedures", "tab": "painting"}'::jsonb
  );
  INSERT INTO public.document_chunks (
    document_id, chunk_index, content, token_count, metadata
  ) VALUES (
...
-- Document 14: Basecoat and Clearcoat Application Guide
DO $$
DECLARE doc_id_14 UUID;
BEGIN
  INSERT INTO public.documents (
    title, description, doc_type, tab_slug, tags, language, is_active, metadata
  ) VALUES (
    'Basecoat and Clearcoat Application Guide',
    'BASECOAT AND CLEARCOAT APPLICATION GUIDE
...
1. Use',
    'procedure',
    'painting',
    ARRAY['basecoat', 'clearcoat', 'application', 'procedures'],
    'en',
    true,
    '{"source": "seed-script"}'::jsonb
  ) RETURNING id INTO doc_id_14;
...
8. Basecoat must be fully flashed before clearcoat application - if clearcoat applied too soon, causes wrinkling',
    585,
    '{"title": "Basecoat and Clearcoat Application Guide", "tab": "painting"}'::jsonb
  );
  INSERT INTO public.document_chunks (
    document_id, chunk_index, content, token_count, metadata
  ) VALUES (
...
-- Document 15: Color Matching and Blending Techniques
DO $$
DECLARE doc_id_15 UUID;
BEGIN
  INSERT INTO public.documents (
    title, description, doc_type, tab_slug, tags, language, is_active, metadata
  ) VALUES (
...
1. Ob',
    'procedure',
    'painting',
    ARRAY['color-matching', 'blending', 'procedures', 'techniques'],
    'en',
    true,
    '{"source": "seed-script"}'::jsonb
  ) RETURNING id INTO doc_id_15;
...
8. Apply clearcoat over entire repair and blend area for uniform protection',
    575,
    '{"title": "Color Matching and Blending Techniques", "tab": "painting"}'::jsonb
  );
  INSERT INTO public.document_chunks (
    document_id, chunk_index, content, token_count, metadata
  ) VALUES (
...
-- Document 16: Reassembly Sequence and Torque Specifications
DO $$
DECLARE doc_id_16 UUID;
BEGIN
  INSERT INTO public.documents (
    title, description, doc_type, tab_slug, tags, language, is_active, metadata
  ) VALUES (
...
1. Begin reassemb',
    'procedure',
    'reassembly',
    ARRAY['reassembly', 'torque', 'procedures', 'fasteners'],
    'en',
    true,
    '{"source": "seed-script"}'::jsonb
  ) RETURNING id INTO doc_id_16;
...
8. Keep threadlocker away from skin and eyes - read product safety data sheet',
    557,
    '{"title": "Reassembly Sequence and Torque Specifications", "tab": "reassembly"}'::jsonb
  );
  INSERT INTO public.document_chunks (
    document_id, chunk_index, content, token_count, metadata
  ) VALUES (
...
-- Document 17: Electrical Reconnection and System Verification
DO $$
DECLARE doc_id_17 UUID;
BEGIN
  INSERT INTO public.documents (
    title, description, doc_type, tab_slug, tags, language, is_active, metadata
  ) VALUES (
    'Electrical Reconnection and System Verification',
    'ELECTRICAL RECONNECTION AND SYSTEM VERIFICATION
...
RECONNECTING HA',
    'procedure',
    'reassembly',
    ARRAY['electrical', 'reconnection', 'verification', 'procedures'],
    'en',
    true,
    '{"source": "seed-script"}'::jsonb
  ) RETURNING id INTO doc_id_17;
...
10. If any lights do not function, check bulbs, connectors, and wiring',
    638,
    '{"title": "Electrical Reconnection and System Verification", "tab": "reassembly"}'::jsonb
  );
  INSERT INTO public.document_chunks (
    document_id, chunk_index, content, token_count, metadata
  ) VALUES (
...
-- Document 18: Trim and Molding Reinstallation Guide
DO $$
DECLARE doc_id_18 UUID;
BEGIN
  INSERT INTO public.documents (
    title, description, doc_type, tab_slug, tags, language, is_active, metadata
  ) VALUES (
    'Trim and Molding Reinstallation Guide',
    'TRIM AND MOLDING REINSTALLATION GUIDE
...
1. Common trim cli',
    'procedure',
    'reassembly',
    ARRAY['trim', 'molding', 'reinstallation', 'procedures'],
    'en',
    true,
    '{"source": "seed-script"}'::jsonb
  ) RETURNING id INTO doc_id_18;
...
8. Do not expose vehicle to water or extreme temperature until adhesive is fully cured',
    620,
    '{"title": "Trim and Molding Reinstallation Guide", "tab": "reassembly"}'::jsonb
  );
  INSERT INTO public.document_chunks (
    document_id, chunk_index, content, token_count, metadata
  ) VALUES (
...
-- Document 19: Glass and Weatherstrip Installation
DO $$
DECLARE doc_id_19 UUID;
BEGIN
  INSERT INTO public.documents (
    title, description, doc_type, tab_slug, tags, language, is_active, metadata
  ) VALUES (
    'Glass and Weatherstrip Installation',
    'GLASS AND WEATHERSTRIP INSTALLATION
...
1. ',
    'procedure',
    'reassembly',
    ARRAY['glass', 'weatherstrip', 'installation', 'procedures'],
    'en',
    true,
    '{"source": "seed-script"}'::jsonb
  ) RETURNING id INTO doc_id_19;
...
10. For clip-on weatherstrip, ensure clips are fully engaged and weatherstrip is secure',
    616,
    '{"title": "Glass and Weatherstrip Installation", "tab": "reassembly"}'::jsonb
  );
  INSERT INTO public.document_chunks (
    document_id, chunk_index, content, token_count, metadata
  ) VALUES (
...
-- Document 20: Mechanical Component Reinstallation
DO $$
DECLARE doc_id_20 UUID;
BEGIN
  INSERT INTO public.documents (
    title, description, doc_type, tab_slug, tags, language, is_active, metadata
  ) VALUES (
    'Mechanical Component Reinstallation',
    'MECHANICAL COMPONENT REINSTALLATION
...
1. Reinstall sus',
    'procedure',
    'reassembly',
    ARRAY['mechanical', 'suspension', 'cooling', 'procedures'],
    'en',
    true,
    '{"source": "seed-script"}'::jsonb
  ) RETURNING id INTO doc_id_20;
...
11. Test brake operation before customer delivery - brakes should apply smoothly',
    644,
    '{"title": "Mechanical Component Reinstallation", "tab": "reassembly"}'::jsonb
  );
  INSERT INTO public.document_chunks (
    document_id, chunk_index, content, token_count, metadata
  ) VALUES (
...
-- Document 21: Final Quality Control Inspection Checklist
DO $$
DECLARE doc_id_21 UUID;
BEGIN
  INSERT INTO public.documents (
    title, description, doc_type, tab_slug, tags, language, is_active, metadata
  ) VALUES (
    'Final Quality Control Inspection Checklist',
    'FINAL QUALITY CONTROL INSPECTION CHECKLIST
...
',
    'checklist',
    'detailing-qc',
    ARRAY['quality-control', 'inspection', 'checklist', 'final'],
    'en',
    true,
    '{"source": "seed-script"}'::jsonb
  ) RETURNING id INTO doc_id_21;
...
☐ Verify no electrical shorts or parasitic draws when vehicle is off',
    581,
    '{"title": "Final Quality Control Inspection Checklist", "tab": "detailing-qc"}'::jsonb
  );
  INSERT INTO public.document_chunks (
    document_id, chunk_index, content, token_count, metadata
  ) VALUES (
...
-- Document 22: Paint Correction and Polishing Procedures
DO $$
DECLARE doc_id_22 UUID;
BEGIN
  INSERT INTO public.documents (
    title, description, doc_type, tab_slug, tags, language, is_active, metadata
  ) VALUES (
    'Paint Correction and Polishing Procedures',
    'PAINT CORRECTION AND POLISHING PROCEDURES
...
1',
    'procedure',
    'detailing-qc',
    ARRAY['polishing', 'paint-correction', 'procedures', 'buffing'],
    'en',
    true,
    '{"source": "seed-script"}'::jsonb
  ) RETURNING id INTO doc_id_22;
...
8. After removing defects, verify surface is smooth before final polishing',
    595,
    '{"title": "Paint Correction and Polishing Procedures", "tab": "detailing-qc"}'::jsonb
  );
  INSERT INTO public.document_chunks (
    document_id, chunk_index, content, token_count, metadata
  ) VALUES (
...
-- Document 23: Interior Detailing After Collision Repair
DO $$
DECLARE doc_id_23 UUID;
BEGIN
  INSERT INTO public.documents (
    title, description, doc_type, tab_slug, tags, language, is_active, metadata
  ) VALUES (
    'Interior Detailing After Collision Repair',
    'INTERIOR DETAILING AFTER COLLISION REPAIR
...
1.',
    'procedure',
    'detailing-qc',
    ARRAY['interior', 'detailing', 'cleaning', 'procedures'],
    'en',
    true,
    '{"source": "seed-script"}'::jsonb
  ) RETURNING id INTO doc_id_23;
...
9. If odors persist after detailing, may require professional odor removal service',
    635,
    '{"title": "Interior Detailing After Collision Repair", "tab": "detailing-qc"}'::jsonb
  );
  INSERT INTO public.document_chunks (
    document_id, chunk_index, content, token_count, metadata
  ) VALUES (
...
-- Document 24: Pre-Delivery Vehicle Inspection
DO $$
DECLARE doc_id_24 UUID;
BEGIN
  INSERT INTO public.documents (
    title, description, doc_type, tab_slug, tags, language, is_active, metadata
  ) VALUES (
...
1. Open hoo',
    'procedure',
    'detailing-qc',
    ARRAY['pre-delivery', 'inspection', 'procedures', 'final-check'],
    'en',
    true,
    '{"source": "seed-script"}'::jsonb
  ) RETURNING id INTO doc_id_24;
...
10. Have vehicle parked in safe, visible location for customer walkthrough',
    621,
    '{"title": "Pre-Delivery Vehicle Inspection", "tab": "detailing-qc"}'::jsonb
  );
  INSERT INTO public.document_chunks (
    document_id, chunk_index, content, token_count, metadata
  ) VALUES (
...
-- Document 25: Documentation and Photo Standards
DO $$
DECLARE doc_id_25 UUID;
BEGIN
  INSERT INTO public.documents (
    title, description, doc_type, tab_slug, tags, language, is_active, metadata
  ) VALUES (
...
',
    'procedure',
    'detailing-qc',
    ARRAY['documentation', 'photos', 'records', 'procedures'],
    'en',
    true,
    '{"source": "seed-script"}'::jsonb
  ) RETURNING id INTO doc_id_25;
...
8. Document any recalls or service bulletins issued for repaired vehicles',
    644,
    '{"title": "Documentation and Photo Standards", "tab": "detailing-qc"}'::jsonb
  );
  INSERT INTO public.document_chunks (
    document_id, chunk_index, content, token_count, metadata
  ) VALUES (
